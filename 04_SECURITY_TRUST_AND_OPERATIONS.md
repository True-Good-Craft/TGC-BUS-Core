...
Manual update staging remains authenticated, write-gated, and user-triggered. This patch release does not introduce auto-install, startup auto-update, telemetry, or silent background update behavior.
